...
The happy path is one config block, one store file, one component. Everything below is encrypted with AES-256-GCM before it touches localStorage / IndexedDB.
